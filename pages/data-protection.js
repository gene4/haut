        ...
        >
            <div>
                ...
                <p>
                    ...
                    priority for the management of the Fá Maria. The use of the
                    Internet pages of the Fá Maria is possible without any
                ...
                <p>
                    ...
                    the Fá Maria. By means of this data protection declaration,
                ...
                <p>
                    As the controller, the Fá Maria has implemented numerous
                ...
                <h4>1. Definitions</h4>
                <p>
                    The data protection declaration of the Fá Maria is based on
                ...
                <p>Fá Maria</p>
                <p>Email: hautonhaut@gmail.com</p>
                <p>Website: https://hautonhaut.com/</p>

                <h4>3. Collection of general data and information</h4>
                <p>
                    The website of the Fá Maria collects a series of general
                    data and information when a data subject or automated system
                    calls up the website. This general data and information are
                    stored in the server log files. Collected may be (1) the
                    browser types and versions used, (2) the operating system
                ...
                <p>
                    When using these general data and information, the Fá Maria
                    ...
                    long-term viability of our information technology systems
                    and website technology, and (4) provide law enforcement
                    authorities with the information necessary for criminal
                    prosecution in case of a cyber-attack. Therefore, the Fá
                    Maria analyzes anonymously collected data and information
                    statistically, with the aim of increasing the data
                    protection and data security of our enterprise, and to
                    ensure an optimal level of protection for the personal data
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <p>
                            ...
                            information. Furthermore, the European directives
                        ...
                        <p>
                            ...
                            of the appropriate safeguards relating to the
                            transfer.
                        </p>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                Article 9(2) of the GDPR, and where there is no
                                other legal ground for the processing.
                            </li>
                            <li>
                                The data subject objects to the processing
                                pursuant to Article 21(1) of the GDPR and there
                                are no overriding legitimate grounds for the
                                processing, or the data subject objects to the
                                processing pursuant to Article 21(2) of the
                                GDPR.{" "}
                            </li>
                            <li>
                        ...
                        <p>
                            ...
                            personal data stored by the Fá Maria, he or she may,
                            at any time, contact any employee of the controller.
                            An employee of Fá Maria shall promptly ensure that
                        ...
                        <p>
                            ...
                            the personal data, the controller, taking account of
                            ...
                            processing is not required. An employees of the Fá
                            Maria will arrange the necessary measures in
                            individual cases.
                        </p>
                    </li>
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                the verification whether the legitimate grounds
                                of the controller override those of the data
                                subject.
                            </li>
                        </ul>
                        <p>
                            If one of the aforementioned conditions is met, and
                            a data subject wishes to request the restriction of
                            the processing of personal data stored by the Fá
                            Maria, he or she may at any time contact any
                            employee of the controller. The employee of the Fá
                            Maria will arrange the restriction of the
                            processing.{" "}
                        </p>
                    </li>
                    <li>
                        ...
                        <p>
                            ...
                            data concerning him or her, which was provided to a
                            ...
                            (b) of Article 6(1) of the GDPR, and the processing
                    ...
                    <li>
                        ...
                        <p>
                            ...
                            or her, which is based on point (e) or (f) of
                            Article 6(1) of the GDPR. This also applies to
                            profiling based on these provisions.
                        </p>

                        <p>
                            The Fá Maria shall no longer process the personal
                        ...
                        <p>
                            If the Fá Maria processes personal data for direct
                            ...
                            data subject objects to the Fá Maria to the
                            processing for direct marketing purposes, the Fá
                            Maria will no longer process the personal data for
                            these purposes.
                        </p>
                        ...
                        <p>
                            ...
                            him or her by the Fá Maria for scientific or
                            historical research purposes, or for statistical
                            purposes pursuant to Article 89(1) of the GDPR,
                        ...
                        <p>
                            ...
                            subject may contact any employee of the Fá Maria. In
                            addition, the data subject is free in the context of
                            the use of information society services, and
                            notwithstanding Directive 2002/58/EC, to use his or
                            her right to object by automated means using
                    ...
                    <li>
                        ...
                        <p>
                            ...
                            and a data controller, or (2) is not authorised by
                            ...
                            and legitimate interests, or (3) is not based on the
                        ...
                        <p>
                            ...
                            the data subject's explicit consent, the Fá Maria
                        ...
                        <p>
                            ...
                            concerning automated individual decision-making, he
                    ...
                    <li>
                        ...
                        <p>
                            ...
                            consent to processing of his or her personal data at
                            any time.{" "}
                        </p>
                        ...
                        <p>
                            ...
                            contact any employee of the Fá Maria.
                        </p>
                    </li>
                </ul>
                <h4>
                    6. Data protection provisions about the application and use
                    of Instagram
                </h4>
                <p>
                    On this website, the controller has integrated components of
                    the service Instagram. Instagram is a service that may be
                    qualified as an audiovisual platform, which allows users to
                    share photos and videos, as well as disseminate such data in
                    other social networks.
                </p>

                <p>
                    The operating company of the services offered by Instagram
                    is Facebook Ireland Ltd., 4 Grand Canal Square, Grand Canal
                ...
                <p>
                    ...
                    which an Instagram component (Insta button) was integrated,
                    the Internet browser on the information technology system of
                    the data subject is automatically prompted to the download
                    of a display of the corresponding Instagram component of
                    Instagram. During the course of this technical procedure,
                    Instagram becomes aware of what specific sub-page of our
                    website was visited by the data subject.
                </p>

                <p>
                    If the data subject is logged in at the same time on
                    Instagram, Instagram detects with every call-up to our
                    website by the data subject—and for the entire duration of
                    their stay on our Internet site—which specific sub-page of
                    our Internet page was visited by the data subject. This
                    information is collected through the Instagram component and
                    is associated with the respective Instagram account of the
                    data subject. If the data subject clicks on one of the
                    Instagram buttons integrated on our website, then Instagram
                    matches this information with the personal Instagram user
                    account of the data subject and stores the personal data.
                </p>

                <p>
                    Instagram receives information via the Instagram component
                    that the data subject has visited our website provided that
                    the data subject is logged in at Instagram at the time of
                    the call to our website. This occurs regardless of whether
                    the person clicks on the Instagram button or not. If such a
                    transmission of information to Instagram is not desirable
                    for the data subject, then he or she can prevent this by
                    logging off from their Instagram account before a call-up to
                    our website is made.
                </p>
                ...
                <p>
                    ...
                    personal data is required, such as for the fulfillment of
                    tax obligations, the processing is based on Art. 6(1) lit. c
                    GDPR. In rare cases, the processing of personal data may be
                    ...
                    lit. d GDPR. Finally, processing operations could be based
                    on Article 6(1) lit. f GDPR. This legal basis is used for
                ...
                <h4>
                    8. The legitimate interests pursued by the controller or by
                    a third party
                </h4>
                <p>
                ...
                <p>
                    ...
                    The data subject is, for example, obliged to provide us with
                ...
                <p>
                    ...
                    <a href="https://abletotrack.com/">free time tracker</a>.
                    The legal texts contained in our privacy policy generator
                    have been provided and published by{" "}
